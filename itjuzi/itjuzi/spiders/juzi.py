...
class ITjuziSpider(RedisCrawlSpider):
    ...
    def start_requests(self):
        ...
        '''
        return [Request("http://itjuzi.com/user/login", meta={'cookiejar': 1}, callback=self.parse_before_login)]


    def parse_before_login(self, response):
        # formdate = {
        #     'identity':'18860402655',
        #     'password':'136172245',
        # }
       # return [scrapy.FormRequest.from_response(response,meta={'cookiejar': response.meta['cookiejar']},formdata=formdate,callback=self.after_login)]
    ...
    def parse_item(self, response):
        ...
        if cpy1:
            # 公司名称：//span[@class="title"]c d/b/text()[1]
